  ...
  return (
    <Animated.View style={[styles.container, Shadows.card, isPressed && Shadows.cardPressed, { transform: [{ scale }] }]}>
      ...
      <View style={styles.info}>
        ...
        <View style={styles.meta}><Text style={styles.rating}>Bud Score {movie.budScore ?? movie.rating}</Text></View>
      </View>
      </Pressable>
    </Animated.View>
  );
...
const styles = StyleSheet.create({
  ...
  image: { aspectRatio: 0.68, backgroundColor: Colors.surfaceElevated, borderRadius: Radius.md, width: "100%" },
  ...
  meta: { alignItems: "center", flexDirection: "row", paddingTop: Spacing.xs },
  rating: { color: Colors.gold, ...Typography.label },
});