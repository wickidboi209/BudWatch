...
function renderFace(vibeId: string, stroke: string, common: { fill: string; stroke: string; strokeLinecap: "round"; strokeLinejoin: "round"; strokeWidth: number }) {
  switch (vibeId) {
    ...
    case "questioning":
      // big neutral curious eyes + a shrug-tilted mouth
      return <>
        <Circle cx={30} cy={50} fill={stroke} r={6.5} />
        <Circle cx={70} cy={50} fill={stroke} r={6.5} />
        <Path d="M34 72 Q50 79 66 70" {...common} strokeWidth={7} />
      </>;
